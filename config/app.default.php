...
return [/**
		 ...
		 */
		'EmailTransport' => ['default' => ['className' => 'Mail',
		 ...
		 */
		'Email' => ['default' => ['transport' => 'default',
								  'from' => 'you@localhost',
								  //'charset' => 'utf-8',
								  //'headerCharset' => 'utf-8',
		],
		 ...
		 */
		'Datasources' => ['default' => ['className' => 'Cake\Database\Connection',
						   ...
						   */
						  'test' => ['className' => 'Cake\Database\Connection',
									 'driver' => 'Cake\Database\Driver\Mysql',
									 'persistent' => false,
									 'host' => 'localhost',
									 //'port' => 'non_standard_port_number',
